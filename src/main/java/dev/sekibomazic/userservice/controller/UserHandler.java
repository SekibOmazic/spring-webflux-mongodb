package dev.sekibomazic.userservice.controller;

import dev.sekibomazic.userservice.controller.validation.ValidatorHandler;
import dev.sekibomazic.userservice.model.User;
import dev.sekibomazic.userservice.service.UserService;
...
public class UserHandler {
    ...
    public Mono<ServerResponse> getUserById(ServerRequest request) {
        ...
        return userService.getUserById(id)
                .flatMap(contact -> ServerResponse
                        .ok()
    ...
    public Mono<ServerResponse> deleteUserByName(ServerRequest request) {
        ...
        return name.map(s -> userService.deleteByName(s)
                    .then(ServerResponse.noContent().build())
                    .switchIfEmpty(ServerResponse.notFound().build()))
